    ...
    <div>
      ...
      <Card>
        ...
        {isLoading ? (
          ...
          <div className="p-12 text-center text-sm text-slate-500">No patients found.</div>
        ) : (
              ...
              <tbody className="divide-y divide-slate-100">
                {patients.map((p) => (
                  <tr key={p.id} className="hover:bg-slate-50">
                    ...
                    <td className="px-4 py-3 text-slate-600">{titleCase(p.gender)}</td>
                    <td className="px-4 py-3 text-slate-600">{calculateAge(p.dateOfBirth)}</td>
