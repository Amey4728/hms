...
class ItemQueryDto extends createZodDto(
  paginationQuerySchema.extend({ category: inventoryCategorySchema.optional() }),
) {}
...
class PurchaseQueryDto extends createZodDto(
  paginationQuerySchema.extend({ status: purchaseStatusSchema.optional() }),
) {}
...
class TransferQueryDto extends createZodDto(
  paginationQuerySchema.extend({ status: transferStatusSchema.optional() }),
) {}
...
export class VendorsController {
  ...
  create(@Body() dto: CreateVendorDto, @CurrentUser('id') u: string) {
    return this.service.createVendor(dto, u);
  }
  @Get()
  @Permissions(M)
  @ResponseMessage('Vendors retrieved successfully')
  list(@Query() q: PaginationQueryDto) {
    return this.service.listVendors(q);
  }
  @Get(':id')
  @Permissions(M)
  ...
  update(
    ...
    return this.service.updateVendor(id, dto, u);
  }
  @Delete(':id')
  @Permissions(M)
  @HttpCode(HttpStatus.OK)
  @ResponseMessage('Vendor deleted successfully')
  remove(@Param('id', new ParseUUIDPipe()) id: string, @CurrentUser('id') u: string) {
    return this.service.removeVendor(id, u);
  }
}
...
export class ItemsController {
  ...
  create(@Body() dto: CreateItemDto, @CurrentUser('id') u: string) {
    return this.service.createItem(dto, u);
  }
  @Get()
  @Permissions(M)
  ...
  @Permissions(M)
  @ResponseMessage('Low-stock items retrieved')
  ...
  update(
    ...
    return this.service.updateItem(id, dto, u);
  }
  @Patch(':id/adjust')
  @Permissions(M)
  ...
  adjust(
    ...
    return this.service.adjustStock(id, dto, u);
  }
  @Delete(':id')
  @Permissions(M)
  @HttpCode(HttpStatus.OK)
  ...
  remove(@Param('id', new ParseUUIDPipe()) id: string, @CurrentUser('id') u: string) {
    return this.service.removeItem(id, u);
  }
}
...
export class PurchaseRequestsController {
  ...
  create(@Body() dto: CreatePurchaseDto, @CurrentUser('id') u: string) {
    return this.service.createPurchase(dto, u);
  }
  @Get()
  @Permissions(M)
  @ResponseMessage('Purchase requests retrieved successfully')
  list(@Query() q: PurchaseQueryDto) {
    return this.service.listPurchases(q);
  }
  @Get(':id')
  @Permissions(M)
  @ResponseMessage('Purchase request retrieved successfully')
  get(@Param('id', new ParseUUIDPipe()) id: string) {
  ...
  @Permissions(M)
  @HttpCode(HttpStatus.OK)
  @ResponseMessage('Purchase request submitted')
  submit(
    @Param('id', new ParseUUIDPipe()) id: string,
    @Body() dto: PurchaseTransitionDto,
    @CurrentUser('id') u: string,
  ) {
    return this.service.submitPurchase(id, dto.version, u);
  }
  @Patch(':id/approve')
  @Permissions(M)
  @HttpCode(HttpStatus.OK)
  @ResponseMessage('Purchase request approved')
  approve(
    @Param('id', new ParseUUIDPipe()) id: string,
    @Body() dto: PurchaseDecisionDto,
    @CurrentUser('id') u: string,
  ) {
    return this.service.approvePurchase(id, dto, u);
  }
  @Patch(':id/reject')
  @Permissions(M)
  @HttpCode(HttpStatus.OK)
  @ResponseMessage('Purchase request rejected')
  reject(
    @Param('id', new ParseUUIDPipe()) id: string,
    @Body() dto: PurchaseDecisionDto,
    @CurrentUser('id') u: string,
  ) {
    return this.service.rejectPurchase(id, dto, u);
  }
  @Patch(':id/receive')
  @Permissions(M)
  @HttpCode(HttpStatus.OK)
  @ResponseMessage('Purchase received (stock updated)')
  ...
  receive(
    ...
    return this.service.receivePurchase(id, dto.version, u);
  }
}
...
export class TransfersController {
  ...
  create(@Body() dto: CreateTransferDto, @CurrentUser('id') u: string) {
    return this.service.createTransfer(dto, u);
  }
  @Get()
  @Permissions(M)
  @ResponseMessage('Transfers retrieved successfully')
  list(@Query() q: TransferQueryDto) {
    return this.service.listTransfers(q);
  }
  @Patch(':id/complete')
  @Permissions(M)
  @HttpCode(HttpStatus.OK)
  @ResponseMessage('Transfer completed')
  complete(@Param('id', new ParseUUIDPipe()) id: string, @Body() dto: TransferTransitionDto) {
    return this.service.completeTransfer(id, dto.version);
  }
}
